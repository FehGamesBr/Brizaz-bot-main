...
const banmsgporn = 'Ta maluco de mandar isso, ja sabe né...'
...
const botfdp = 'Ta maluco rapaz, te deitar na porrada quando tiver dormindo'
...
const botcorno = 'sai fora, jogador de ff, comprador de pack do pézinho'
const botputa = 'Senhora sua mãe 😡'
const botgay = 'Olha quem fala 😡'
const botviado = 'Olha que fala😡'
